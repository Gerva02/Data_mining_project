...
Anche in questo caso si riporta lo stesso grafico di prima per mostrare tutti i k possibili e la loro relativa accuratezza. Purtroppo la scelta del parametro k ricade su un valore molto elevato e determina una inevitabile influenza sulla previsione da parte delle classi più numerose, causando novetoli problemi in fase di valutazione del modello e utilizzo poi in un futuro per scopi reali. Per questo motivo in seguito si opterà per un valore massimo di k inferiore.
...
È interessante sottolineare come tutti i metodi preferiscano la scelta di un modello in generale più complesso che rischia di incombere in problemi di overfitting, riscontrando sì un bias inferiore ma trovando molte difficoltà nell'effetturare previsione su dati sconosciuti al modello.
