...
Anche in questo caso si riporta lo stesso grafico di prima per mostrare tutti i k possibili e la loro relativa accuratezza purtroppo la scelta del parametro k ricade su un valore molto elevato e determina una inevitabile influenza sulla previsione da parte delle classi più numerose, causando notevoli problemi in fase di valutazione del modello e utilizzo poi in un futuro per scopi reale. Per questo motivo in seguito si opterà per un valore massimo di k inferiore.
