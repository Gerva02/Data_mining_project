...
* La varianza e la scala degli elementi chimici sono diverse tra di loro: questo porterà a effettuare una normalizzazione, utile per esempio quando verrà applicato l'algoritmo K-NN.
