...
Si notano diversi split che sembrano poco utili alla fine dell'albero. Questi splittano infatti nella stessa classe e potrebbero essere in futuro potati tramite tencniche di pruning.
...
Il metodo migliore sembra per ora essere il KNN con distanze euclidee con un'accuracy di 0.64.
