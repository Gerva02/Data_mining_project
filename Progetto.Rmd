...
knn.pred <- knn(train=train_norm, test=test_norm, cl=labels_train, k = 8)
...
tree.best.glass <- tree(Type ~. , glass.train)
pruned.best.tree <-prune.tree(tree.best.glass  ,method="misclass", k = pruned.tree.k[3] )
tree.best.pred <-predict(pruned.best.tree  , test_norm[-10] , type = "class")
