...
* La varianza e la scala degli elementi chimici sono diverse tra di loro: questo porta a effettuare una normalizzazione, utile per esempio quando verrà applicato l'algoritmo K-NN.
...
* La distribuzione condizionata per ogni elemento chimico non sembra essere quasi mai normale: viene quindi rifiutata anche l'analisi discriminante quadratica (QDA), oltre a LDA. Si conferma inoltre l'asimmetria. 
